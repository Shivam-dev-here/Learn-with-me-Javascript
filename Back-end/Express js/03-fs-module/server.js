...
// // console.log("starting");                                                                // #1
// // fs.writeFile("created2.txt", "this is going to be inside that file",()=>{              // #3
// //     // console.log("completed");

// // })
// // console.log("Ending");

// fs.readFile("created2.txt", (error, data) => {
//   console.log(error, data); //data.tostring()
// }); // #2 won't wait for writefile
...
let my_path =
  "C:\\Users\\myper\\Desktop\\Github\\Javascript\\Back-end\\new\\fs & path module (file work)\\created.txt";
